    ...
    if (viewportWidth >= 1024) {
        ...
        jQuery(".hfe-nav-menu li>a").each(function () {
            ...
            if (jQuery(currentid).size() > 0) {
                // if (rel == "howitshelps") {
                //     if (jQuery(currentid).position().top - jQuery('header').height() - 80 - parseInt(jQuery(this).css("padding-top").slice(0, -2)) <= scrollPos && jQuery(currentid).position().top + jQuery(currentid).height() > scrollPos) {
                //         jQuery(".hfe-nav-menu li>a").parent().removeClass("current_page_item");
        ...
        jQuery(".hfe-nav-menu li>a").each(function () {
            ...
            if (jQuery(currentid).size() > 0) {
                // if (rel == "howitshelps") {
                //     if (jQuery(currentid).position().top - jQuery('header').height() - 80 - parseInt(jQuery(this).css("padding-top").slice(0, -2)) <= scrollPos && jQuery(currentid).position().top + jQuery(currentid).height() > scrollPos) {
                //         jQuery(".hfe-nav-menu li").parent().removeClass("current_page_item");
                //         jQuery(this).parent().addClass("current_page_item");
                //     }
                // }
                // else {
        ...
        jQuery(".hfe-nav-menu li>a").each(function () {
            ...
            if (jQuery(currentid).size() > 0) {
                // if (rel == "howitshelps") {
                //     if (jQuery(currentid).position().top - jQuery('header').height() - 50 - parseInt(jQuery(this).css("padding-top").slice(0, -2)) <= scrollPos && jQuery(currentid).position().top + jQuery(currentid).height() > scrollPos) {
                //         jQuery(".hfe-nav-menu li>a").parent().removeClass("current_page_item");
                //         jQuery(this).parent().addClass("current_page_item");
                //     }
                // }
